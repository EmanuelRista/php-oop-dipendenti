...
class ImpiegatoAdOre extends Impiegato
{
  ...
  public function calcola_compenso()
  {
    echo "<br><strong>Compenso calcolato:</strong> " . ($this->compenso_orario * $this->ore_lavorate);
  }
}
class ImpiegatoSalariato extends Impiegato
{
  ...
  public function calcola_compenso()
  {
    echo "<br><strong>Compenso calcolato:</strong> " . ($this->compenso_giornaliero * $this->giorni_lavorati);
  }
}
...
class ImpiegatoSuCommissione extends Impiegato
{
  ...
  public function calcola_compenso()
  {
    echo "<br><strong>Compenso calcolato:</strong> " . ($this->commissione_progetto);
  }
}
